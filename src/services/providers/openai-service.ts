...
export class OpenAIService extends AiServiceProvider {
  ...
  constructor(config?: Partial<AiServiceConfig>) {
    ...
    super({
      ...
      apiKey: config?.apiKey || getValidatedApiKey(API_CONFIG.openai.apiKey),
      organizationId: config?.organizationId || getValidatedApiKey(API_CONFIG.openai.organizationId),
